...
const SUNGLASSES_MENU = buildFrameMega("solntsezashchitnye", {
  ...
  featured: {
    ...
    description:
      "Поляризация, комфортные линзы и универсальные формы для города, отпуска и вождения. Выбираем модели с чистыми линиями, удобной посадкой и спокойным дизайном.",
