...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      // z-[70]: the lens wizard is a full-screen fixed layer at z-[60]; a dialog
      // opened from inside it (the «i» detail) must sit ABOVE it or it renders
      // behind the opaque wizard and looks like nothing happened.
